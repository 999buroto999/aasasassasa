...
class CONFIG:
    TOKEN = "OTU4NjE3NTE3NDQ4OTEyOTE3.YkP8Ig.d-w8YC9cuqTegWjIuaBLu_JwQk8" # Your Token
    PREFIX = "=" # Your Prefix
...
async def help(ctx):
    ...
    embed.add_field(name="join voice", value="join shodn dr voice", inline=False)
    embed.add_field(name="disconnect voice", value="disconnect shodn dr voice", inline=False)
    await ctx.reply(embed=embed)
